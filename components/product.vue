            ...
            <form @submit.prevent="submit" class="space-y-8">
                <div>
                    ...
                    <input type="text" id="title"
                        ...
                        placeholder="Product title" required v-model="form.title">
                </div>
                <div>
                    <label for="seo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Seo
                        (Slug)</label>
                    <input type="text" id="seo"
                        class="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                        placeholder="Product seo" required v-model="form.seo">
                </div>
                ...
                <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-3 lg:grid-cols-4 xl:gap-x-8">
                    <div>
                        <label for="stock-code"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Stock Code</label>
                        <input type="text" id="stock-code"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="Stock Code" required v-model="form.stockCode">
                    </div>
                    <div>
                        <label for="barcode"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Barcode</label>
                        <input type="text" id="barcode"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="Barcode" required v-model="form.barcode">
                    </div>
                    <div>
                        <label for="associative"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Associative</label>
                        <input type="text" id="associative"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="Associative" required v-model="form.associative">
                    </div>
                    <div>
                        <label for="tax" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tax</label>
                        <input type="number" id="tax"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="Tax" required v-model="form.tax">
                    </div>
                </div>
                <button type="submit"
